...
「源石黑體」是基於「源起黑體」改造的開放原始碼中文字型。專案嘗試重現早期鉛字時代黑體那種樸實、剛硬且略帶粗獷的視覺感受，減少現代黑體過於精緻的修飾，適用於需要力道、復古感與工業風的排版場景。
...
「源石ゴシック」は、源起ゴシックをベースに、昔の活字風の力強さを再現したフリーフォントです。角張った造形とレトロな骨格により、硬派でインダストリアルな印象を与え、インパクトのある見出しやレトロなデザインにマッチします。
...
**GenSeki Gothic** is an open-source Pan-CJK font derived from Genki Gothic. It aims to recreate the raw, sturdy, and unpolished feel of early letterpress Gothic typefaces. By simplifying modern ornaments, it provides a bold and vintage aesthetic suitable for industrial or heavy-duty design contexts.
